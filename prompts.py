...
def get_speiseplan_prompt(wochen, menulinien, menu_namen):
    ...
    return (
        ...
        "WICHTIG - ABWECHSLUNG UND KEINE DOPPLUNGEN:\n"
        "- Jedes Hauptgericht darf im gesamten Speiseplan nur EINMAL vorkommen\n"
        "- Verwende eine große Vielfalt an verschiedenen Gerichten für jeden Tag\n"
        "- Vermeide Wiederholungen von Gerichten über alle Tage und Wochen hinweg\n"
        "- Achte auf maximale Abwechslung: Jeder Tag soll komplett andere Gerichte haben\n"
        "- Auch ähnliche Gerichte (z.B. verschiedene Schnitzel-Varianten) sollen vermieden werden\n"
        "- Bei mehreren Menülinien: Auch zwischen den Menülinien am selben Tag sollen die Gerichte unterschiedlich sein\n\n"
        "BEILAGENBEISPIELE:\n"
